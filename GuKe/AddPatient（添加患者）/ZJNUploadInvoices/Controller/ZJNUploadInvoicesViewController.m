...
- (id<MWPhoto>)photoBrowser:(MWPhotoBrowser *)photoBrowser photoAtIndex:(NSUInteger)index{
    ...
    if (signIndexPath.section == 0) {
          photimageStr  =[NSString stringWithFormat:@"%@",HYArr[index]];
        if ([photimageStr containsString:imgPath]) {
          ...
          photimageStr  =[NSString stringWithFormat:@"%@",XArr[index]];
        if ([photimageStr containsString:imgPath]) {
        }else{
            photimageStr = [NSString stringWithFormat:@"%@%@",imgPath,photimageStr];
        }
         ...
         photimageStr  =[NSString stringWithFormat:@"%@",TWArr[index]];
        if ([photimageStr containsString:imgPath]) {
        }else{
            photimageStr = [NSString stringWithFormat:@"%@%@",imgPath,photimageStr];
        }
         ...
         photimageStr  =[NSString stringWithFormat:@"%@",BTArr[index]];
        if ([photimageStr containsString:imgPath]) {
        }else{
            photimageStr = [NSString stringWithFormat:@"%@%@",imgPath,photimageStr];
        }
 ...
 */
        ...
        NSMutableDictionary * datadic =[[ NSMutableDictionary alloc]initWithDictionary:self.fInfoDic];
        [datadic removeObjectForKey:@"sessionid"];
        [datadic setObject:sessionIding forKey:@"sessionId"];
        NSLog(@"%@",datadic);
        
        
        [self showHudInView:self.view hint:nil];
        [ZJNRequestManager postWithUrlString:urlString parameters:datadic success:^(id data) {
            NSLog(@"添加回访记录%@",data);
            NSString *retcode = [NSString stringWithFormat:@"%@",data[@"retcode"]];
            if ([retcode isEqualToString:@"0"]) {
                [self showHint:data[@"message"]];
