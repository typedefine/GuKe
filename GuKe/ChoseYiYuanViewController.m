...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *rightBarItem = [[UIBarButtonItem alloc] initWithTitle:@"确定" style:UIBarButtonItemStylePlain target:self action:@selector(onClickedOKNeedView)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (tableView == yishengTable) {
        ...
        UILabel *titleLabss = [[UILabel alloc]initWithFrame:CGRectMake(20, 11,200, 20)];
