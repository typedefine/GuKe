...
//    [self makeZhuJian];
    ...
    titleArr = @[@[@"姓名",@"性别",@"年龄",@"住院号"],@[@"手术日期",@"手术名称",@"手术入路",@"手术医生",@"第一助手",@"第二助手"]];
...
- (id<MWPhoto>)photoBrowser:(MWPhotoBrowser *)photoBrowser photoAtIndex:(NSUInteger)index{
    MWPhoto *photot;
    if (signIndexPath.section == 4) {
         NSString * photimageStr  =[NSString stringWithFormat:@"%@",qxImagePathArr[index]];
        ...
        photot = [MWPhoto photoWithURL:[NSURL URLWithString:photimageStr]];
         ...
         NSString * photimageStr  =[NSString stringWithFormat:@"%@",xImagePathArr[index]];
        if ([photimageStr containsString:imgPath]) {
        }else{
            photimageStr = [NSString stringWithFormat:@"%@%@",imgPath,photimageStr];
        }
        photot = [MWPhoto photoWithURL:[NSURL URLWithString:photimageStr]];
         ...
         NSString * photimageStr  =[NSString stringWithFormat:@"%@",SImagePathArr[index]];
        if ([photimageStr containsString:imgPath]) {
        }else{
            photimageStr = [NSString stringWithFormat:@"%@%@",imgPath,photimageStr];
        }
