...
- (void)setMainVC:(GuKeViewController *)mainVC
{
    _mainVC = mainVC;
...
/*    [[NSUserDefaults standardUserDefaults]removeObjectForKey:@"passWord"];
    ...
    */
    ...
    //[[NSNotificationCenter defaultCenter]postNotificationName:KNOTIFICATION_LOGINCHANGE object:@{@"state":@NO,@"index":@"0"}];
