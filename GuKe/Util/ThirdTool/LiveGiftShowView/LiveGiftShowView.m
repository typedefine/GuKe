...
- (void)setModel:(LiveGiftShowModel *)model{
    ...
    [self.giftIV sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",model.giftModel.picUrl]] placeholderImage:[UIImage imageNamed:model.giftModel.placeImg]];
