//
//  ZJNPatientBodyInfoViewController.m
//  GuKe
//
...
@interface ZJNPatientBodyInfoViewController ()<UITableViewDelegate,UITableViewDataSource,ZJNChoosePCellDelegate,ChoseViewDelegate,MWPhotoBrowserDelegate,UINavigationControllerDelegate,ZYQAssetPickerControllerDelegate,UIImagePickerControllerDelegate,ZJNPatientBodyInfoDelegate,TZImagePickerControllerDelegate>
{
...
@implementation ZJNPatientBodyInfoViewController
...
-(void)nextButtonClick:(UIButton *)button{
    ...
    if (!patientInfoview) {
        patientInfoview = [[PatientInfoViewController alloc]init];
    }
    patientInfoview.infoModel = self.infoModel;
    patientInfoview.hidesBottomBarWhenPushed = YES;
    [self.navigationController pushViewController:patientInfoview animated:NO];
}
-(void)initInfoStr{
