...
- (void)viewDidLoad {
    ...
    UIToolbar *toolbar = [[UIToolbar alloc] initWithFrame:CGRectMake(0.0f, 22.0f, kScreenWidth, 44.0f)];
    ...
    previewLayer.frame = CGRectMake(0.0f, CGRectGetMaxY(toolbar.frame), kScreenWidth, PKPreviewLayerHeight);
    [self.view.layer insertSublayer:previewLayer atIndex:0];
    
    self.progressBar = [[PKShortVideoProgressBar alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(previewLayer.frame) - 5, kScreenWidth, 5) themeColor:self.themeColor duration:self.videoMaximumDuration];
