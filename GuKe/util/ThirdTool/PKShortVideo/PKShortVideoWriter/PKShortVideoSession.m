...
- (void)prepareToRecord {
    ...
    if (!error && _videoTrackSourceFormatDescription) {
        [self setupAssetWriterVideoInputWithSourceFormatDescription:self.videoTrackSourceFormatDescription settings:self.videoTrackSettings error:&error];
    }
...
- (BOOL)setupAssetWriterVideoInputWithSourceFormatDescription:(CMFormatDescriptionRef)videoFormatDescription settings:(NSDictionary *)videoSettings error:(NSError **)errorOut {
