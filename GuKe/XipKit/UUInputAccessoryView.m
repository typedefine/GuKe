...
+ (UUInputAccessoryView*)sharedView {
    ...
    dispatch_once(&once, ^ {
        ...
        [saveBtn setTitleColor:[UIColor colorWithHex:0x999999] forState:UIControlStateNormal];
...
-(void)textViewDidChange:(UITextView *)textView
{
    ...
    if (BtnSave.enabled) {
        [BtnSave setTitleColor:[UIColor colorWithHex:0x333333] forState:UIControlStateNormal];

    }else{
        [BtnSave setTitleColor:[UIColor colorWithHex:0x999999] forState:UIControlStateNormal];
